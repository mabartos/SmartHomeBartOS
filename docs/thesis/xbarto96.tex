...
%change Abstract
  ...
  Cílém této bakalářské práce je vytvořit komplexní levné řešení chytré domácnosti, které bude schopen uživatel spravovat bez většího úsilí. 
  ...
  The goal of this bachelor thesis is to create a comprehensive low-cost smart home solution that the user will be able to manage without much effort.  
...
% I have listed all the literary sources, publications and other sources, which were used during the preparation of this thesis.},
  ...
  acknowledgment={Rád bych poděkoval za odbornou pomoc od mého vedoucího pana Doc. Ing. Vladimíra Janouška Ph.D., který mi pomohl dostat se na správný směr mé bakalářské práce a dále pomáhal navrhovat a konzultoval dané řešení.},
