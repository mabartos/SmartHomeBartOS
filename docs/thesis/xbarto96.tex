...
\projectinfo{
  ...
  % Abstrakt / Abstract
  abstract.cs={V dnešní době se velice rychle rozrůstá svět chytrých zařízení v domácnostech, které mezi sebou komunikují a usnadňují život lidem. Avšak velkým problémem pořízení takových zařízení do běžných domácností je vysoká cena  a kompatibilita zařízení pouze od jednoho výrobce. Cílém této bakalářské práce je vytvořit komplexní levné řešení, které dokáže komunikovat se zařízeními od různých výrobců. }, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
