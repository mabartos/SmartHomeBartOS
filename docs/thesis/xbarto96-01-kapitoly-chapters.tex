...
Dále hlavním rysem tohoto projektu je poskytnutní přístupnosti k domácnosti. Tento systém je navržen tak, aby mohl být nasazen v cloudu a být přístupný pro tisíce uživatelů zároveň. Vyžaduje se určitá robustnost systému a hlavně i bezpečnost.
...
\section{IoT - Internet of Things (Internet věcí)}
\label{terminy:iot}
...
ale přesto je schopno pracovat samostatně v existující infrastruktuře internetu.~\cite{iotWikipedia}
\newline
...
\begin{figure}
  \centering
  \includegraphics[width=.8 \linewidth]{obrazky-figures/iot.jpeg}
  \caption{
    Koncept IoT v domácnosti
  }
\end{figure}
...
Vestavěný systém je jednoúčelový počítač, který slouží většinou k jednomu účelu.
